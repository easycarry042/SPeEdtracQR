...
<<<<<<< Updated upstream:speed-traqr/resources/views/track/index.blade.php
        <div class="rounded-2xl border border-gray-200/90 bg-white p-8 shadow-lg shadow-gray-200/60 ring-1 ring-gray-100">
            ...
            <form method="GET" action="{{ route('track.index') }}" class="mt-6 space-y-4">
                <input name="tracking_number" class="w-full rounded-xl border border-gray-200 px-4 py-3 text-lg shadow-sm transition focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30" placeholder="SPD-YYYYMMDD-XXXXX">
...
>>>>>>> Stashed changes:resources/views/track/index.blade.php
                    Search
                </button>
            </form>
        </div>

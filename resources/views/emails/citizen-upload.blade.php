...
<body style="font-family: Arial, sans-serif; line-height: 1.5; color: #1a1a1a;">
    ...
    <p>A citizen uploaded {{ $fileCount }} file(s) for a ticket assigned to <strong>{{ $document->assignedTo->name ?? 'you' }}</strong>.</p>
    ...
    <p style="margin-top: 1.5rem;">
        <a href="{{ route('track.show', $document->tracking_number) }}" style="background: #1a5c1a; color: #fff; padding: 10px 16px; text-decoration: none; border-radius: 8px;">Open document</a>
    </p>

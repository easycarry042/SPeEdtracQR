{{--
    Show/hide button for a password field. Place inside a `relative` wrapper whose
    input uses `:type="show ? 'text' : 'password'"`. The `show` state is expected
    to live on a parent Alpine `x-data="{ show: false }"` scope, so one toggle can
    reveal several fields (e.g. password + confirmation) at once.
--}}

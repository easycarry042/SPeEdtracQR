<x-app-layout>
    ...
    <div class="page-shell page-shell-narrow">
        <section class="panel">
            <div class="ph"><h2>Department Details</h2></div>
            <form method="POST" action="{{ route('admin.departments.update', $department) }}" class="pb space-y-5 p-6">
                @csrf @method('PUT')
                @include('admin.departments.partials.form-fields')

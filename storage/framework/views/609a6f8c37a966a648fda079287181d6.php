...
<div id="createDocumentModal"
     class="<?php echo e($createModalAutoOpen ? '' : 'hidden'); ?> fixed inset-0 z-[100]"
        ...
        <div class="relative flex h-full max-h-[52rem] w-full max-w-5xl flex-col overflow-hidden rounded-3xl border border-gray-200/90 bg-white shadow-2xl">
            ...
            <div id="createModalBody" class="grid min-h-0 flex-1 grid-cols-1 gap-8 overflow-y-auto p-6 lg:grid-cols-2 lg:overflow-hidden">
                ...
                <div id="routeBuilder"
                     ...
                     data-departments='<?php echo json_encode($createModalDepartments->map(fn ($d) => ['id' => $d->id, 'name' => $d->name])->values(), 512) ?>'
                     data-default-routes='<?php echo json_encode($createModalDefaultRoutes, 15, 512) ?>'
                     data-old-route='<?php echo json_encode(collect(old('route_departments', []))->map(fn ($id) => (int) $id)->values(), 512) ?>'
                     data-old-type='<?php echo json_encode(old('document_type', ''), 512) ?>'>
                    <form id="submissionForm" method="POST" action="<?php echo e(route('documents.store')); ?>" enctype="multipart/form-data" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <input name="remarks" value="<?php echo e(old('remarks')); ?>" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 transition focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30" placeholder="File Name">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-gray-600">Description</label>
                            <textarea name="description" rows="3" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 transition focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30" placeholder="Description"><?php echo e(old('description')); ?></textarea>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="document_type" id="documentTypeSelect"
                                ...
                                <?php $__currentLoopData = $createModalCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category); ?>" <?php if(old('document_type') === $category): echo 'selected'; endif; ?>><?php echo e($category); ?></option>
                        ...
                        <div class="rounded-xl border border-emerald-200/80 bg-emerald-50/40 p-4">
                            ...
                            <?php $__errorArgs = ['route_departments'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                <p id="routeClientError" class="mb-2 text-sm font-medium text-red-600"><?php echo e($message); ?></p>
                            <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-center">
                                <select id="routeDeptPicker"
                                    ...
                                    <?php $__currentLoopData = $createModalDepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div>
                            ...
                            <input name="citizen_name" value="<?php echo e(old('citizen_name')); ?>" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 transition focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30">
                        </div>
                        <div>
                            <label class="mb-1 block text-sm font-medium text-gray-600">Citizen Contact</label>
                            <input name="citizen_contact" value="<?php echo e(old('citizen_contact')); ?>" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 transition focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/30">
                        </div>
...
<?php /**PATH C:\Users\conso\Downloads\SPeEdtracQR\resources\views/documents/partials/create-modal.blade.php ENDPATH**/ ?>
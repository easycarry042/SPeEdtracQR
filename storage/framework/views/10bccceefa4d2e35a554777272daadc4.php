...
>>>>>>> Stashed changes:resources/views/analytics.blade.php
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
            <div class="rounded-xl border border-emerald-200 bg-white p-4 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500"><?php echo e($isOrgWide ? 'In transit' : 'At your department'); ?></p>
                <p class="mt-2 text-3xl font-bold text-emerald-800"><?php echo e($summary['at_department']); ?></p>
            </div>
            <div class="rounded-xl border border-emerald-200 bg-white p-4 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Completed</p>
                <p class="mt-2 text-3xl font-bold text-emerald-800"><?php echo e($summary['completed']); ?></p>
            </div>
            <div class="rounded-xl border border-emerald-200 bg-white p-4 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wide text-gray-500">Submitted this month</p>
                <p class="mt-2 text-3xl font-bold text-emerald-800"><?php echo e($summary['submitted_month']); ?></p>
            </div>
            <div class="rounded-xl border border-amber-200 bg-amber-50 p-4 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-wide text-amber-800">Overdue now</p>
                <p class="mt-2 text-3xl font-bold text-amber-700"><?php echo e($summary['overdue']); ?></p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div class="rounded-xl border border-[#e0e0e0] bg-white p-6 lg:col-span-2">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    <?php echo e($isOrgWide ? 'All offices — new submissions vs completions per day.' : 'Documents linked to your department.'); ?>
                    ...
                    <div>
                        ...
                        <select id="status" class="mt-1 block h-10 w-full rounded-lg border border-gray-300 text-sm shadow-sm">
                            ...
                            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($status); ?>"><?php echo e(str_replace('_', ' ', ucfirst($status))); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div>
            ...
            <div class="rounded-xl border border-[#e0e0e0] bg-white p-6">
                ...
                <table class="mt-4 min-w-full">
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $byType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-b border-gray-100 last:border-0">
                                <td class="py-2 text-sm text-gray-800"><?php echo e($row->document_type); ?></td>
                                <td class="py-2 text-right text-sm font-bold text-emerald-800"><?php echo e($row->total); ?></td>
                            </tr>
            ...
            <div class="rounded-xl border border-[#e0e0e0] bg-white p-6">
                <?php if($isOrgWide): ?>
                    ...
                    <table class="mt-5 min-w-full">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $topDepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deptRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b border-[#e0e0e0] last:border-b-0">
                                    <td class="px-4 py-3 text-[14px] text-[#1a1a1a]"><?php echo e($deptRow->name); ?></td>
                                    <td class="px-4 py-3 text-right text-[14px] font-bold text-[#1a5c1a]"><?php echo e($deptRow->total); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <?php else: ?>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Documents linked to <?php echo e($dept?->name ?? 'your department'); ?></p>
                    <table class="mt-5 min-w-full">
                        <thead class="bg-[#fafafa]">
                            <tr>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $statusBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b border-[#e0e0e0] last:border-b-0">
                                    <td class="px-4 py-3 text-[14px] capitalize text-[#1a1a1a]"><?php echo e(str_replace('_', ' ', $row->status)); ?></td>
                                    <td class="px-4 py-3 text-right text-[14px] font-bold text-[#1a5c1a]"><?php echo e($row->total); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <script>
        ...
        async function loadChart() {
            ...
            try {
                const response = await fetch(`<?php echo e(route('analytics.data')); ?>?${params}`, {
...
<?php endif; ?>
<?php /**PATH C:\Users\conso\Downloads\SPeEdtracQR\resources\views/analytics.blade.php ENDPATH**/ ?>
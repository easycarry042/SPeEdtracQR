<<<<<<< Updated upstream:storage/framework/views/29ccaf6bad3c30b7d6ff5c0fb81d5814.php
...
=======
<x-app-layout>
>>>>>>> Stashed changes:resources/views/movements/index.blade.php
    <div class="mx-auto max-w-7xl space-y-6" id="movementsPage">
        ...
        <div class="flex items-center gap-1 rounded-2xl border border-gray-200 bg-gray-100 p-1 w-fit shadow-sm">
            <a href="<?php echo e(request()->fullUrlWithQuery(['tab' => 'inbox'])); ?>"
               class="px-5 py-2 rounded-xl text-sm font-semibold transition-all
                      <?php echo e($tab === 'inbox' ? 'bg-white text-emerald-900 shadow' : 'text-gray-500 hover:text-gray-800'); ?>">
                Inbox
                <?php if($inboxDocuments->total() > 0): ?>
                    <span class="ml-1.5 rounded-full <?php echo e($tab === 'inbox' ? 'bg-emerald-100 text-emerald-800' : 'bg-gray-200 text-gray-600'); ?> px-2 py-0.5 text-xs font-bold">
                        <?php echo e($inboxDocuments->total()); ?>

                    </span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(request()->fullUrlWithQuery(['tab' => 'tracking'])); ?>"
               class="px-5 py-2 rounded-xl text-sm font-semibold transition-all
                      <?php echo e($tab === 'tracking' ? 'bg-white text-emerald-900 shadow' : 'text-gray-500 hover:text-gray-800'); ?>">
                Tracking
                <?php if($trackingDocuments->total() > 0): ?>
                    <span class="ml-1.5 rounded-full <?php echo e($tab === 'tracking' ? 'bg-emerald-100 text-emerald-800' : 'bg-gray-200 text-gray-600'); ?> px-2 py-0.5 text-xs font-bold">
                        <?php echo e($trackingDocuments->total()); ?>

                    </span>
                <?php endif; ?>
            </a>
            <a href="<?php echo e(request()->fullUrlWithQuery(['tab' => 'sent'])); ?>"
               class="px-5 py-2 rounded-xl text-sm font-semibold transition-all
                      <?php echo e($tab === 'sent' ? 'bg-white text-emerald-900 shadow' : 'text-gray-500 hover:text-gray-800'); ?>">
                Sent Today
                <?php if($sentDocuments->total() > 0): ?>
                    <span class="ml-1.5 rounded-full <?php echo e($tab === 'sent' ? 'bg-emerald-100 text-emerald-800' : 'bg-gray-200 text-gray-600'); ?> px-2 py-0.5 text-xs font-bold">
                        <?php echo e($sentDocuments->total()); ?>
        ...
        <form method="GET" class="flex flex-wrap items-center gap-3">
            ...
            <?php if($isOrgWide): ?>
                <select name="department" class="rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm shadow-sm focus:border-emerald-400 focus:outline-none">
                    ...
                    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($dept->id); ?>" <?php if(request('department') == $dept->id): echo 'selected'; endif; ?>><?php echo e($dept->name); ?></option>
            ...
            <label class="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm shadow-sm cursor-pointer">
                <input type="checkbox" name="overdue" value="1" <?php if(request()->boolean('overdue')): echo 'checked'; endif; ?>
            ...
            <?php if(request()->hasAny(['department', 'overdue'])): ?>
                <a href="<?php echo e(route('movements.index', ['tab' => $tab])); ?>" class="rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-semibold text-gray-600 hover:bg-gray-50">
                    Clear
                </a>
            <?php endif; ?>
        </form>
        ...
        <?php if($activeSet->isEmpty()): ?>
            <div class="rounded-2xl border border-gray-200/90 bg-white px-6 py-16 text-center shadow-sm">
                ...
                <p class="text-sm font-medium text-gray-500"><?php echo e($emptyMessage); ?></p>
            </div>
        <?php else: ?>
            <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-3">
                <?php $__currentLoopData = $activeSet; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="relative flex flex-col overflow-hidden rounded-2xl border border-gray-200 border-l-4 <?php echo e($borderColor); ?> bg-white shadow-sm transition hover:shadow-md">

                        
                        <div class="h-1 w-full bg-gray-100">
                            <div class="h-1 <?php echo e($slaBarColor); ?> transition-all duration-500" style="width: <?php echo e($document->slaPct); ?>%"></div>
                        </div>
                        ...
                        <div class="flex flex-col gap-4 p-5">
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex items-center gap-3 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        <p class="truncate text-sm font-bold text-gray-900"><?php echo e($document->document_type); ?></p>
                                        <p class="truncate text-xs text-gray-500"><?php echo e($document->citizen_name ?? '—'); ?></p>
                                    </div>
                                </div>
                                <div class="shrink-0 text-right">
                                    <p class="font-mono text-xs font-semibold text-emerald-700"><?php echo e($document->tracking_number); ?></p>
                                    <span class="mt-1 inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-xs font-semibold <?php echo e($slaBadge); ?>">
                                        <?php echo e($slaLabel); ?>
                            ...
                            <?php if($document->routingChain->isNotEmpty()): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.routing-stepper','data' => ['document' => $document,'chain' => $document->routingChain,'compact' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['document' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($document),'chain' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($document->routingChain),'compact' => true]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.document-images','data' => ['document' => $document,'class' => 'mt-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['document' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($document),'class' => 'mt-1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <?php if($tab === 'tracking' && $document->currentDepartment): ?>
                                <p class="text-xs text-gray-500">
                                    Currently at: <span class="font-semibold text-emerald-800"><?php echo e($document->currentDepartment->name); ?></span>
                                </p>
                            <?php endif; ?>

                            <?php if($tab === 'inbox' && $document->canAct): ?>
                                <?php
                                ...
                                <div class="flex items-center gap-2 border-t border-gray-100 pt-3">
                                    <a href="<?php echo e(url('/track/'.$document->tracking_number)); ?>" target="_blank" rel="noopener"
                                    ...
                                    <button type="button"
                                            ...
                                            data-from="<?php echo e($document->current_department_id); ?>"
                                            data-to="<?php echo e($document->nextDepartment?->id ?? ''); ?>"
                                            data-dept="<?php echo e($document->nextDepartment?->name ?? ''); ?>"
                                            data-type="<?php echo e($document->document_type); ?>"
                                            data-citizen="<?php echo e($document->citizen_name ?? ''); ?>"
                                            data-remarks="<?php echo e($document->remarks ?? ''); ?>"
                                            data-description="<?php echo e($document->description ?? ''); ?>"
                                            data-images='<?php echo json_encode($reviewImages, 15, 512) ?>'
                                            data-last-stop="<?php echo e($document->isLastStop ? '1' : '0'); ?>">
            ...
            <?php if($activeSet->hasPages()): ?>
                <div class="pt-2">
                    ...
                    ?>
                    <?php echo e($activeSet->appends(request()->except($pageParam))->links()); ?>
    ...
    <script>
        (function () {
            ...
            const scanUrl = <?php echo json_encode(route('api.scan.store'), 15, 512) ?>;
            const attachmentUrlBase = <?php echo json_encode(url('/documents'), 15, 512) ?>;
            const completeUrlBase = <?php echo json_encode(url('/documents'), 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\Users\conso\Downloads\SPeEdtracQR\resources\views/movements/index.blade.php ENDPATH**/ ?>
...
<body class="min-h-screen bg-[#f1f2f1] antialiased text-gray-900">
    ...
    <header class="sticky top-0 z-50 border-b border-emerald-200/60 bg-[#f1f2f1]/90 backdrop-blur-md">
        <div class="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('images/icon.png')); ?>" alt="SPeED TraQR" class="h-9 w-9 rounded-xl">
            ...
            <nav class="flex items-center gap-3">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="rounded-xl bg-emerald-700 px-5 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-800 active:scale-95">
                        Go to Dashboard
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="rounded-xl border border-emerald-300 bg-white px-5 py-2 text-sm font-semibold text-emerald-900 shadow-sm transition hover:bg-emerald-50">
                        Staff Sign In
                    </a>
                <?php endif; ?>
            </nav>
    ...
    <section class="mx-auto max-w-6xl px-6 pb-16 pt-20 text-center">
        ...
        <div class="mx-auto mt-10 max-w-xl">
            <form action="<?php echo e(route('track.search')); ?>" method="GET">
    ...
    <footer class="border-t border-emerald-200/60 bg-[#f1f2f1] py-8">
        <div class="mx-auto max-w-6xl px-6 text-center text-xs text-gray-400">
            &copy; <?php echo e(date('Y')); ?> SPeED TraQR — Document Tracking System. All rights reserved.
        </div>
    </footer>

</body>
</html>
<?php /**PATH C:\Users\conso\Downloads\SPeEdtracQR\resources\views/welcome.blade.php ENDPATH**/ ?>
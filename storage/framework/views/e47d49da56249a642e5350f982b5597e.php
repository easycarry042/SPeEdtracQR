<<<<<<< Updated upstream:storage/framework/views/e47d49da56249a642e5350f982b5597e.php
...
=======
<x-app-layout>
>>>>>>> Stashed changes:resources/views/scan/index.blade.php
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div class="rounded-xl border border-[#e0e0e0] bg-white p-5">
                <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
                    <div>
                        ...
                        <select id="department_id" class="w-full rounded-lg border border-gray-300 px-3 py-2 <?php echo e(!$isOrgWide ? 'bg-gray-100' : ''); ?>" <?php if(!$isOrgWide): echo 'disabled'; endif; ?>>
                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($department->id); ?>" <?php if((int)$userDepartmentId === (int)$department->id): echo 'selected'; endif; ?>><?php echo e($department->name); ?></option>
                ...
                <div id="nextDeptWrap" class="mt-3 hidden">
                    ...
                    <select id="next_department_id" class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm">
                        ...
                        <?php $__currentLoopData = $allDepartments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="rounded-xl border border-[#e0e0e0] bg-white p-5">
                ...
                <ul id="sessionLog" class="mt-3 space-y-2">
                    <?php $__currentLoopData = $sessionScans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="rounded-md bg-gray-100 px-3 py-2 text-sm">
                            <strong><?php echo e($scan['tracking_number']); ?></strong> - <?php echo e($scan['action']); ?> (<?php echo e($scan['department']); ?>) at <?php echo e($scan['at']); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\conso\Downloads\SPeEdtracQR\resources\views/scan/index.blade.php ENDPATH**/ ?>
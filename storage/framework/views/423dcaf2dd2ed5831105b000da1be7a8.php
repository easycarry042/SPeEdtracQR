...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Track a Document <?php $__env->endSlot(); ?>
    ...
    <div class="mx-auto max-w-2xl space-y-6">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <form method="GET" action="<?php echo e(route('citizen.track')); ?>" class="mt-4 space-y-4">
                ...
                <div class="flex gap-3">
                    <input id="tracking"
                           type="text"
                           name="tracking"
                           value="<?php echo e(request('tracking')); ?>"
    ...
    <script>
        const trackUrl = <?php echo json_encode(route('citizen.track'), 15, 512) ?>;
        let scanner = null;
...
<?php endif; ?>
<?php /**PATH C:\Users\conso\Downloads\SPeEdtracQR\resources\views/citizen/track.blade.php ENDPATH**/ ?>
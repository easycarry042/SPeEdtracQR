    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // The irreplaceable data: uploaded scans/attachments + QR
                    // images. Application code is versioned in git, so it is not
                    // duplicated here; the database is dumped automatically below.
                    storage_path('app'),
                ],
         ...
         * Kept outside storage/app so it is never swept into a backup.
         */
